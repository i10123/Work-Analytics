export const DOM = {
  ...
  dashscopeStatusText: document.getElementById('openrouterStatusText'),
  dashscopeKeyRow: document.getElementById('openrouterKeyRow'),
  dashscopeKeyText: document.getElementById('openrouterKeyText'),
  currencyStatusText: document.getElementById('currencyStatusText'),
  currencyKeysRow: document.getElementById('currencyKeysRow'),
  currencyKeysList: document.getElementById('currencyKeysList'),
